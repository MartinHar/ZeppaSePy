...
class add_chain:
    ...
    # contactEmail = driver.find_element(By.CSS_SELECTOR, '[name="contactEmail"]')                      not yet impl.
    ...
    sameCheckbox.click()
    # attachZIP = driver.find_element(By.XPATH, "//input[@type='file']")                                not yet impl.
    # attachZIP.send_keys('/Users/martinharutyunyan/Desktop/PythonAutomationZeppa/ZeppaAutomationSEPython/Data/mainFile/zip.zip')
